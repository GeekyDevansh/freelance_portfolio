    ...
    <>
     <div className="mx-auto md:w-3/4 flex flex-col md:flex-row gap-4 md:gap-0 justify-between mt-[5%] items-center font-arsenica font-semibold md:text-5xl text-3xl">
      ...
      <div className="flex flex-wrap md:flex-nowrap gap-10 w-3/4 mx-auto my-16 justify-between items-center">
        ...
        <button class="py-2 px-4 shadow-md no-underline border-2 border-black font-dmsans font-semibold text-sm btn-primary focus:outline-none active:shadow-none mr-2">Next.js</button>
        ...
        <button class="py-2 px-4 shadow-md no-underline border-2 border-black font-dmsans font-semibold text-sm btn-primary focus:outline-none active:shadow-none mr-2">Sanity.io</button>
        <button class="py-2 px-4 shadow-md no-underline border-2 border-black font-dmsans font-semibold text-sm btn-primary focus:outline-none active:shadow-none mr-2">Stripe</button>
        </div>

        <div className="font-arsenica md:text-4xl text-3xl font-semibold mx-auto flex justify-center items-center my-16" >
                About The Project
        </div>
        <p className="font-dmsans w-1/2 mx-auto md:text-xl text-lg mt-12" >Moda Online Shopping is a streamlined e-commerce platform with a user-friendly UI, utilizing Next.js for frontend development, Sanity.io as a headless CMS for product management, and Stripe for secure payment processing.</p>
