  ...
  return (
    <>
      <div className="mx-auto md:w-3/4 flex flex-col md:flex-row gap-4 md:gap-0 justify-between mt-[5%] items-center font-arsenica font-semibold md:text-5xl text-3xl">
        <div>MatchMyService</div>
        <a
          className="font-dmsans font-medium md:text-lg text-sm border-2 border-black active:translate-x-[2px] active:translate-y-[2px] active:shadow-[4px_4px_0_#000000] px-4 py-2 shadow-[6px_6px_0_#000000]"
      ...
      <div className="flex flex-wrap md:flex-nowrap gap-10 w-3/4 mx-auto my-16 justify-between items-center">
        ...
        <button class="py-2 px-4 shadow-md no-underline border-2 border-black font-dmsans font-semibold text-sm btn-primary focus:outline-none active:shadow-none mr-2">Framer Motion</button>
        <button class="py-2 px-4 shadow-md no-underline border-2 border-black font-dmsans font-semibold text-sm btn-primary focus:outline-none active:shadow-none mr-2">Vercel</button>
        <button class="py-2 px-4 shadow-md no-underline border-2 border-black font-dmsans font-semibold text-sm btn-primary focus:outline-none active:shadow-none mr-2">TailwindCSS</button>
        ...
        <p className="font-dmsans w-1/2 mx-auto md:text-xl text-lg mt-12" >MatchMyService is a web-based platform that connects service seekers with service providers. Its intuitive interface and bidding system enable users to post requirements, compare bids, and hire the best service provider.</p>
