    ...
    <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
       ...
       {darkMode?<img src="/darkComputer.svg" alt="" />:<img src="/computer.svg" alt="" />}
        ...
        transition={{duration:1,ease:'easeOut'}} class={`font-semibold font-arsenica ${darkMode?"text-white":"text-gray-900"} mb-1 text-xl`}>Experienced Freelance Web Developer & Designer:</motion.h2>
          <motion.p  initial={{opacity:0,y:"50%"}}
        whileInView={{opacity:1,y:0}}
        transition={{duration:1,ease:'easeOut',delay:0.1}} class={`${darkMode?"text-gray-400":"text-gray-600"} leading-relaxed`}>Based in India with over 3 years of experience, I specialize in crafting visually stunning websites and seamless user experiences. From web development to design, I bring a holistic approach to digital solutions.</motion.p>
        </div>
      </div>
    </div>
    <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <motion.h2 initial={{opacity:0,y:"50%"}}
        whileInView={{opacity:1,y:0}}
        transition={{duration:1,ease:'easeOut'}} class={`font-semibold font-arsenica ${darkMode?"text-white":"text-gray-900"} mb-1 text-xl`}>Cutting-Edge Technology Integration:</motion.h2>
          <motion.p  initial={{opacity:0,y:"50%"}}
        whileInView={{opacity:1,y:0}}
        transition={{duration:1,ease:'easeOut',delay:0.1}} class={`${darkMode?"text-gray-400":"text-gray-600"} leading-relaxed`}>I pride myself on integrating the latest technology into websites, ensuring not only aesthetic appeal but also a solid technological foundation. Additionally, I offer web designing expertise for a comprehensive user experience.</motion.p>
        </div>
      </div>
    </div>
    <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
      ...
      <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <motion.h2 initial={{opacity:0,y:"50%"}}
        whileInView={{opacity:1,y:0}}
        transition={{duration:1,ease:'easeOut'}} class={`font-semibold font-arsenica ${darkMode?"text-white":"text-gray-900"} mb-1 text-xl`}>Diverse Web Solution Portfolio:</motion.h2>
          <motion.p  initial={{opacity:0,y:"50%"}}
        whileInView={{opacity:1,y:0}}
        transition={{duration:1,ease:'easeOut',delay:0.1}} class={`${darkMode?"text-gray-400":"text-gray-600"} leading-relaxed`}>My proficiency extends to creating various web solutions, including captivating landing pages, e-commerce platforms, portfolios and many more. This diversity showcases adaptability in delivering bespoke solutions.</motion.p>
        </div>
      </div>
    </div>
    <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
      ...
      <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <motion.h2 initial={{opacity:0,y:"50%"}}
        whileInView={{opacity:1,y:0}}
        transition={{duration:1,ease:'easeOut'}} class={`font-semibold font-arsenica ${darkMode?"text-white":"text-gray-900"} mb-1 text-xl`}>SEO Optimization for Visibility:</motion.h2>
          <motion.p  initial={{opacity:0,y:"50%"}}
        whileInView={{opacity:1,y:0}}
        transition={{duration:1,ease:'easeOut',delay:0.1}} class={`${darkMode?"text-gray-400":"text-gray-600"} leading-relaxed`}>Beyond development and design, I specialize in SEO to enhance website visibility. This strategic approach ensures that the websites I build are not just visually appealing but also optimized for search engines.</motion.p>
        </div>
      </div>
    </div>
  </div>
