    ...
    <>
     <div className="mx-auto md:w-3/4 flex flex-col md:flex-row gap-4 md:gap-0 justify-between mt-[5%] items-center font-arsenica font-semibold md:text-5xl text-3xl">
      ...
      <div className="flex flex-wrap md:flex-nowrap gap-10 w-3/4 mx-auto my-16 justify-between items-center">
        ...
        <p className="font-dmsans w-1/2 mx-auto md:text-xl text-lg mt-12" >VkiwiTech is a web-based platform that boasts a captivating UI with dynamic animations and an interactive carousel, showcasing their IT consulting prowess. The seamless contact form ensures effortless client engagement, making it a visually appealing and user-friendly platform for exploring cutting-edge IT solutions.</p>
